#ifndef EVALUATION_H_CC7CE113236C
#define EVALUATION_H_CC7CE113236C


struct PieceSqTable
{
	int values[64];
	constexpr int operator[](uint64_t pieces) const
	{
		int value;
		for (value = 0; pieces; value += values[pop_lsb(pieces)]) {}
		return value;
	}
};
...
namespace Eval
{
	static constexpr PieceSqTable MG_PAWN_VALUE[2]
	{
		{ // WHITE
			  0,   0,   0,   0,   0,   0,   0,   0,
	...
	static constexpr PieceSqTable EG_PAWN_VALUE[2]
	{
		{ // WHITE
			  0,   0,   0,   0,   0,   0,   0,   0,
	...
	static constexpr PieceSqTable MG_KNIGHT_VALUE[2]
	{
		{ // WHITE
	...
	static constexpr PieceSqTable EG_KNIGHT_VALUE[2]
	{
		{ // WHITE
	...
	static constexpr PieceSqTable MG_BISHOP_VALUE[2]
	{
		{ // WHITE
	...
	static constexpr PieceSqTable EG_BISHOP_VALUE[2]
	{
		{ // WHITE
	...
	static constexpr PieceSqTable MG_ROOK_VALUE[2]
	{
		{ // WHITE
	...
	static constexpr PieceSqTable EG_ROOK_VALUE[2]
	{
		{ // WHITE
	...
	static constexpr PieceSqTable MG_QUEEN_VALUE[2]
	{
		{ // WHITE
	...
	static constexpr PieceSqTable EG_QUEEN_VALUE[2]
	{
		{ // WHITE
	...
	static constexpr PieceSqTable MG_KING_VALUE[2]
	{
		{ // WHITE
	...
	static constexpr PieceSqTable EG_KING_VALUE[2]
	{
		{ // WHITE
	...
	static constexpr int MG_PIECE_VALUES[7] { 0, 82, 337, 365, 477, 1025, 0 };
	static constexpr int EG_PIECE_VALUES[7] { 0, 94, 281, 297, 512,  936, 0 };
} // namespace Eval
...
#endif // EVALUATION_H_CC7CE113236C
